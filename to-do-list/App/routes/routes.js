...
import {create_new_chat, get_all_chats_data, get_chat_messages, get_chat_users, get_chats_user, new_chat_message, update_chat_users} from "../controllers/chats.js";
...
router.post("/GetAllChatData", get_all_chats_data);
